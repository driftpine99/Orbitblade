> Historischer Schnappschuss vor der Konsolidierung am 31.08.2026.
> Ausschließlich [CLAUDE.md](../../CLAUDE.md) im Projektstamm ist verbindlich.
> Der folgende Text bleibt als Beleg vollständig erhalten und enthält überholte Aussagen.
